        ...
        <div class='vote_box'>
          ...
          <button type="submit" name="vote_up" value="1" class="arrow vote_up">
            #{if vote && vote.value > 0
                image_tag("vote_up.png", :width => 15, :height => 10, :title => I18n.t("votes.control.have_voted_up"))
              else
                image_tag("to_vote_up.png", :width => 15, :height => 10, :title => I18n.t("votes.control.to_vote_up"))
              end
             }
          </button>
          ...
          <button type="submit" name="vote_down" value="-1" class="arrow vote_down">
            #{if vote && vote.value < 0
                image_tag("vote_down.png", :width => 15, :height => 10, :title => I18n.t("votes.control.have_voted_down"))
              else
                image_tag("to_vote_down.png", :width => 15, :height => 10, :title => I18n.t("votes.control.to_vote_down"))
              end}
          </button>
        </div>
      </form>
      ...
      %@
        <div class='vote_box'>
          <div class="arrow vote_up">
            #{image_tag("to_vote_up.png", :width => 15, :height => 10)}
          </div>
          <div class="votes_average">
            #{calculate_votes_average(voteable)}
          </div>
          <div class="arrow vote_down">
            #{image_tag("to_vote_down.png", :width => 15, :height => 10)}
          </div>
        </div>
      @
    end
