...
Time.zone.now ? 1 : 0)
  ...
  def ignore_topic!(topic)
    ...
    if user_topic && user_topic.ignoring
      return
    end

    if user_topic
      user_topic.ignoring = true
      user_topic.save
